    ...
    //Lặp qua  mỗi rule và xử lí lắng nghe sự kiện (blur ,input..)
     options.rules.forEach(rule => {
        ...
        if(Array.isArray(selectorRules[rule.selector])){
         ...
         // Không dùng document vì nếu nhiều form trùng tên nó sẽ bị get nhầm
...
//Nguyên tắc của các rrule là gi
// 1. Khi có lỗi => trả ra Mess
// 2. Khi hợp lệ => ko trả ra gi "undefine"
